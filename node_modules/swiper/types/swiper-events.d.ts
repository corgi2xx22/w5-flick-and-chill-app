...
import { A11yEvents } from 'swiper/types/components/a11y';
import { AutoplayEvents } from 'swiper/types/components/autoplay';
import { ControllerEvents } from 'swiper/types/components/controller';
import { CoverflowEffectEvents } from 'swiper/types/components/effect-coverflow';
import { CubeEffectEvents } from 'swiper/types/components/effect-cube';
import { FadeEffectEvents } from 'swiper/types/components/effect-fade';
import { FlipEffectEvents } from 'swiper/types/components/effect-flip';
import { HashNavigationEvents } from 'swiper/types/components/hash-navigation';
import { HistoryEvents } from 'swiper/types/components/history';
import { KeyboardEvents } from 'swiper/types/components/keyboard';
import { LazyEvents } from 'swiper/types/components/lazy';
import { MousewheelEvents } from 'swiper/types/components/mousewheel';
...
import { ParallaxEvents } from 'swiper/types/components/parallax';
import { ScrollbarEvents } from 'swiper/types/components/scrollbar';
import { ThumbsEvents } from 'swiper/types/components/thumbs';
import { VirtualEvents } from 'swiper/types/components/virtual';
import { ZoomEvents } from 'swiper/types/components/zoom';
